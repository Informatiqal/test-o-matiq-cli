...
export function printHelp() {
  const messages = [
    "",
    `test-o-matiq CLI\x1b[32;1m v${pkg.version}\x1b[0m`,
    "",
    ...
    "",
    "Examples:",
    "$ test-o-matiq --file ./deployment.yaml",
    "$ test-o-matiq --file ./deployment.json --json",
    "$ test-o-matiq --file ./deployment.yaml --output ./deployment_result.json",
    "",
